...
RSpec.describe Rspec::Isolate do
  ...
  context "when calling an isolated class", throw_on_call: [ ChildClass ] do
    it "throws" do
      expect do
    ...
    it "does not throw when isolated" do
  ...
  context "when calling a deeply nested isolated class", throw_on_call: [ NestingModule::NestingModuleTwo::ChildClass ] do
    it "throws" do
      expect do
